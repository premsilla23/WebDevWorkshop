...
const SESSIONS = [
    ...
    },
    {
        ...
        blurb: "Routes, requests and responses. What actually happens between a form submit and a row landing in a database.",
        topics: ["node", "express", "REST", "postgres"],
        status: "next",
        accent: "purple",
    },
];
                    ...
                    <div className={styles.heroInner}>
                        <div className={styles.heroCopy}>
                            ...
                            <div className={styles.buttonRow}>
                                <Link href="/frontend" className={styles.buttonPrimary}>
                                    <span className={styles.prompt}>~$</span>
                                    frontend-basics
                                    <span className={styles.arrow}>↵</span>
                                </Link>
                                <Link href="/backend" className={styles.buttonSecondary}>
                                    <span className={styles.prompt}>~$</span>
                                    backend-basics
                                    <span className={styles.arrow}>↵</span>
                                </Link>
